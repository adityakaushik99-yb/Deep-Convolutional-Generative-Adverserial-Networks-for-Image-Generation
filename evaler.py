...
class Evaler(object):
	...
	def __init__(self, config, dataset):
		...
		_, self.batch = create_input_ops(dataset, self.batch_size, is_training = False, shuffle = False)
		...
		session_config = tf.ConfigProto(allow_soft_placement = True, gpu_options = tf.GPUOptions(allow_growth=True), device_count = {'GPU':1})
...
def main():
	...
	parser.add_argument('--dataset', type=str, default='CIFAR10', choices=['Fashion', 'CIFAR10'])
